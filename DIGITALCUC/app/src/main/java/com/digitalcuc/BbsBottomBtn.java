...
public class BbsBottomBtn extends LinearLayout {
	...
	private Context  mContext;
		    ...
		    public BbsBottomBtn(Context context) {	
		        super(context);       
		    }		
		    public BbsBottomBtn(Context context, AttributeSet attrs) {	
		        super(context, attrs);	
			...
			private void showPopupWindow(View parent) {
				...
				if (popWindow == null) {
					...
					View view = layoutInflater.inflate(R.layout.bbs_tab, null);
